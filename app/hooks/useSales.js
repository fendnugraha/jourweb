...
export function useSales({ selectedWarehouse, startDate, endDate }) {
    ...
    const { data, error, isValidating, mutate } = useSWR(
        shouldFetch ? `/api/get-tx-by-warehouse/${selectedWarehouse}/${finalStartDate}/${finalEndDate}` : null,
        fetcher,
        {
    ...
    return {
        txByWarehouse: data, // Sudah otomatis default [] karena fallbackData
