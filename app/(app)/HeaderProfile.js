import { Warehouse, Trophy, TrendingUp, Star, Clock, CheckCircle2, AlertTriangle, Loader2 } from "lucide-react";
                    ...
                    {isLoading ? (
                        ...
                        <>
                            ...
                            <div className="flex items-center gap-2.5 px-3 py-2 sm:px-3.5 sm:py-2.5 rounded-xl bg-slate-50 dark:bg-slate-800/60 border border-slate-100 dark:border-slate-800 shrink-0">
                                ...
                                <div>
                                    <div className="text-[9px] sm:text-[10px] font-bold tracking-wider text-slate-400 capitalize">Today{"'s"} Profit</div>
