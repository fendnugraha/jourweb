...
const SessionVerifier = ({
  title = "Memverifikasi Sesi Anda",
  subtitle = "Pemeriksaan autentikasi & enkripsi akun",
}) => {
  return (
    <div className="relative flex min-h-screen w-full items-center justify-center bg-slate-50 font-sans dark:bg-slate-950 p-4 overflow-hidden">
      ...
      >
        ...
        <div className="relative flex h-14 w-14 items-center justify-center">
          ...
          {/* Core Shield Box */}
          <div className="relative flex h-12 w-12 items-center justify-center rounded-2xl bg-indigo-50 text-indigo-600 border border-indigo-100/80 dark:bg-indigo-950/60 dark:text-indigo-400 dark:border-indigo-900/50 shadow-2xs">
