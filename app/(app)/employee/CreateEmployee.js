...
const CreateEmployee = ({ contacts = [], notification, mutateEmployee }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const errorMsg = error?.response?.data?.message || "An error occurred while creating the employee.";
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid sm:grid-cols-2 gap-3">
                ...
                <div className="space-y-1">
                    <label htmlFor="emp-hire-date" className="text-xs font-semibold text-slate-500 dark:text-slate-400"></label>
                    <input
                        id="emp-hire-date"
                        type="date"
                        required
            ...
            <div className="grid sm:grid-cols-2 gap-3">
                <div className="space-y-1">
                    <label htmlFor="emp-id-card" className="text-xs font-semibold text-slate-500 dark:text-slate-400">
                        No. Kartu ID
                    </label>
                    <input
                        id="emp-id-card"
            ...
            {formData.employment_type === "contract" && (
                <div className="grid sm:grid-cols-2 gap-3 pt-1">
                    <div className="space-y-1">
                        <label htmlFor="emp-contract-duration" className="text-xs font-semibold text-slate-500 dark:text-slate-400">
                            Lama Kontrak
                        </label>
                        <Dropdown
                            ...
                            onChange={(val) => setFormData({ ...formData, contract_duration: val })}
                        />
                    </div>
                    <div className="space-y-1">
