      ...
      <div className="grid sm:grid-cols-2 gap-3">
        ...
        <div className="space-y-1">
          ...
          <Dropdown
            ...
            onChange={(val) =>
              setUpdateUserData({ ...updateUserData, warehouse: val })
            }
          />
        </div>
        ...
        <div className="space-y-1">
          ...
          <Dropdown
            ...
            onChange={(val) =>
              setUpdateUserData({ ...updateUserData, role: val })
            }
          />
        </div>
      </div>
      ...
      <div className="grid sm:grid-cols-2 gap-3">
        <div className="space-y-1">
          ...
          <Dropdown
            ...
            onChange={(val) =>
              setUpdateUserData({ ...updateUserData, contact: val })
            }
          />
        </div>
        <div className="space-y-1">
          ...
          <Dropdown
            ...
            selectedValue={updateUserData.is_active}
            onChange={(val) =>
              setUpdateUserData({ ...updateUserData, is_active: val })
            }
          />
        </div>
      </div>
