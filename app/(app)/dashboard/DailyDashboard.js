...
// Variant Motion untuk Animasi Bertahap (Stagger)
...
export default function DailyDashboardGrid({ userRole, warehouseId }) {
  ...
  const warehouse = !["Administrator", "Super Admin"].includes(userRole)
    ? warehouseId
    : "all";
  ...
  const { dailyDashboard, isLoading, isValidating } = useDailyDashboard(
    selectedWarehouse,
  ...
  return (
    <div className="space-y-6">
      ...
      <motion.div
        ...
        initial="hidden"
        animate="show"
        className="grid grid-cols-1 lg:grid-cols-12 gap-4 w-full h-full font-sans antialiased text-slate-800 dark:text-slate-100 p-1"
      >
        ...
        <div className="lg:col-span-9 grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <motion.div
            ...
            className="relative overflow-hidden rounded-3xl bg-linear-to-br from-indigo-50/80 via-slate-50/90 to-indigo-100/50 dark:from-indigo-950/80 dark:via-slate-900/90 dark:to-slate-900 border border-indigo-200/60 dark:border-indigo-500/20 p-6 shadow-sm dark:shadow-2xl backdrop-blur-xl flex flex-col justify-between group"
          >
            <div className="absolute -top-12 -left-12 w-48 h-48 bg-indigo-500/10 dark:bg-indigo-600/15 rounded-full blur-3xl pointer-events-none group-hover:scale-110 transition-transform duration-500" />
            ...
            <div>
              <div className="flex items-center justify-between mb-5">
                <span className="inline-flex items-center gap-2 text-[11px] font-bold uppercase tracking-wider text-indigo-700 dark:text-indigo-300 bg-indigo-100 dark:bg-indigo-500/15 border border-indigo-300/60 dark:border-indigo-500/30 px-3.5 py-1 rounded-full">
                  <Wallet className="w-3.5 h-3.5 text-indigo-600 dark:text-indigo-400 group-hover:rotate-12 transition-transform" />{" "}
                  Likuiditas Utama
                </span>
              </div>
            ...
            <div className="grid grid-cols-2 gap-3 mt-6 pt-4 border-t border-indigo-200/40 dark:border-slate-800/80">
              <div className="bg-white/80 dark:bg-slate-900/80 p-3 rounded-2xl border border-indigo-100 dark:border-slate-800 transition-colors group-hover:border-indigo-300 dark:group-hover:border-indigo-900">
          ...
          <motion.div
            variants={itemVariants}
            whileHover={{ y: -3, transition: { duration: 0.2 } }}
            className="relative overflow-hidden rounded-3xl bg-linear-to-br from-emerald-50/80 via-slate-50/90 to-emerald-100/40 dark:from-emerald-950/60 dark:via-slate-900/90 dark:to-slate-900 border border-emerald-200/60 dark:border-emerald-500/20 p-6 shadow-sm dark:shadow-2xl backdrop-blur-xl flex flex-col justify-between group"
          >
            <div className="absolute -top-12 -right-12 w-48 h-48 bg-emerald-500/10 dark:bg-emerald-600/10 rounded-full blur-3xl pointer-events-none group-hover:scale-110 transition-transform duration-500" />
            ...
            <div>
              <div className="flex items-center justify-between mb-5">
                <span className="inline-flex items-center gap-2 text-[11px] font-bold uppercase tracking-wider text-emerald-700 dark:text-emerald-400 bg-emerald-100 dark:bg-emerald-500/15 border border-emerald-300/60 dark:border-emerald-500/30 px-3.5 py-1 rounded-full">
                  <Gem className="w-3.5 h-3.5 text-emerald-600 dark:text-emerald-400 group-hover:scale-125 transition-transform" />{" "}
                  Net Profit
                </span>
              </div>
              ...
              <div className="bg-white/80 dark:bg-slate-900/80 p-3 rounded-2xl border border-slate-200/60 dark:border-slate-800">
                <div className="flex items-center justify-between text-xs text-slate-500 dark:text-slate-400 mb-1">
                  ...
                  <span className="text-[10px] font-bold bg-emerald-100 dark:bg-emerald-500/20 text-emerald-700 dark:text-emerald-300 px-1.5 py-0.5 rounded-full">
                    {isLoading
                      ? "..."
                      : formatNumber(Number(data?.totalTransfer?.count || 0))}
                    x
                  </span>
                </div>
                <p className="text-sm font-bold text-slate-800 dark:text-white">
                  {isLoading ? (
                    ...
                    formatNumberToK(Number(data?.totalTransfer?.total || 0))
                  )}
                </p>
              </div>
              ...
              <div className="bg-white/80 dark:bg-slate-900/80 p-3 rounded-2xl border border-slate-200/60 dark:border-slate-800">
                <div className="flex items-center justify-between text-xs text-slate-500 dark:text-slate-400 mb-1">
                  ...
                  <span className="text-[10px] font-bold bg-amber-100 dark:bg-amber-500/20 text-amber-700 dark:text-amber-300 px-1.5 py-0.5 rounded-full">
                    {isLoading
                      ? "..."
                      : formatNumber(
                          Number(data?.totalCashWithdrawal?.count || 0),
                        )}
                    x
                  </span>
                </div>
                <p className="text-sm font-bold text-slate-800 dark:text-white">
                  {isLoading ? (
                    ...
                    formatNumberToK(
                      Number(data?.totalCashWithdrawal?.total || 0),
                    )
                  )}
                </p>
              </div>
          ...
          <div className="md:col-span-2 grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <motion.div
              variants={itemVariants}
              whileHover={{ y: -3, transition: { duration: 0.2 } }}
              className="bg-white dark:bg-slate-900/90 border border-slate-200 dark:border-slate-800 rounded-3xl p-5 shadow-xs flex flex-col justify-between group"
            >
              <div className="flex items-center justify-between">
                <span className="text-xs font-semibold text-slate-500 dark:text-slate-400">
                  Voucher & SP
                </span>
                <div className="p-2.5 bg-indigo-50 dark:bg-indigo-500/10 border border-indigo-100 dark:border-indigo-500/20 rounded-2xl text-indigo-600 dark:text-indigo-400 group-hover:scale-110 transition-transform">
              ...
              <div className="mt-4">
                <span className="text-[11px] font-bold bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 px-2.5 py-1 rounded-full">
                  {isLoading
                    ? "..."
                    : `${formatNumber(Number(data?.totalVoucher?.count || 0))} Pcs`}
                </span>
                <h2 className="text-2xl font-bold text-slate-900 dark:text-white mt-2">
                  {isLoading ? (
                    <Loader2 className="animate-spin w-4 h-4" />
                  ) : (
                    formatNumber(Number(data?.totalVoucher?.total || 0))
                  )}
                </h2>
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <div className="p-2.5 bg-amber-50 dark:bg-amber-500/10 border border-amber-100 dark:border-amber-500/20 rounded-2xl text-amber-600 dark:text-amber-400 group-hover:scale-110 transition-transform">
              ...
              <div className="mt-4">
                <span className="text-[11px] font-bold bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 px-2.5 py-1 rounded-full">
                  {isLoading
                    ? "..."
                    : `${formatNumber(Number(data?.totalAccessories?.count || 0))} Pcs`}
                </span>
                <h2 className="text-2xl font-bold text-slate-900 dark:text-white mt-2">
                  {isLoading ? (
                    <Loader2 className="animate-spin w-4 h-4" />
                  ) : (
                    formatNumber(Number(data?.totalAccessories?.total || 0))
                  )}
                </h2>
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <div className="p-2.5 bg-sky-50 dark:bg-sky-500/10 border border-sky-100 dark:border-sky-500/20 rounded-2xl text-sky-600 dark:text-sky-400 group-hover:scale-110 transition-transform">
              ...
              <div className="mt-4">
                <span className="text-[11px] font-bold bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 px-2.5 py-1 rounded-full">
                  {isLoading
                    ? "..."
                    : `${formatNumber(Number(data?.totalCashDeposit?.count || 0))} Tx`}
                </span>
                <h2 className="text-2xl font-bold text-slate-900 dark:text-white mt-2">
                  {isLoading ? (
                    <Loader2 className="animate-spin w-4 h-4" />
                  ) : (
                    formatNumber(Number(data?.totalCashDeposit?.total || 0))
                  )}
                </h2>
              </div>
            </motion.div>
        ...
        <div className="lg:col-span-3 flex flex-col gap-3">
          ...
          <motion.div
            ...
            className="relative overflow-hidden bg-linear-to-r from-violet-600 to-indigo-600 p-5 rounded-3xl shadow-md text-white flex items-center justify-between group"
          >
            <div>
              <p className="text-[11px] font-bold tracking-wider uppercase text-violet-200">
                Total Setoran
              </p>
              <h2 className="text-2xl font-extrabold text-white mt-0.5">
                {isLoading ? (
                  ...
                  `Rp ${formatNumber(totalSetoran)}`
                )}
              </h2>
            </div>
            <div className="p-3 bg-white/20 backdrop-blur-md rounded-2xl border border-white/30 group-hover:rotate-6 transition-transform">
          ...
          <motion.div
            variants={itemVariants}
            whileHover={{ x: 3 }}
            className="bg-white dark:bg-slate-900/90 border border-slate-200 dark:border-slate-800 p-4 rounded-2xl flex items-center justify-between shadow-xs transition-colors hover:border-slate-300 dark:hover:border-slate-700"
          >
              ...
              <div>
                ...
                <h3 className="text-base font-bold text-slate-800 dark:text-white mt-0.5">
                  {isLoading ? (
                    ...
                    formatNumber(Number(data?.totalFee || 0))
                  )}
                </h3>
              </div>
            </div>
              ...
              <div>
                ...
                <h3 className="text-base font-bold text-slate-800 dark:text-white mt-0.5">
                  {isLoading ? (
                    ...
                    formatNumber(Number(data?.totalBankFee || 0))
                  )}
                </h3>
              </div>
            </div>
              ...
              <div>
                ...
                <h3 className="text-base font-bold text-slate-800 dark:text-white mt-0.5">
                  {isLoading ? (
                    ...
                    `${formatNumber(Number(data?.salesCount || 0))} Tx`
                  )}
                </h3>
              </div>
            </div>
