        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800/80 p-5 rounded-2xl shadow-sm space-y-4">
            ...
            <div className="space-y-1">
                ...
                {isLoading ? (
                    ...
                    accounts.map((account) => (
                        ...
                        >
                            ...
                            <div className="min-w-0 flex-1 pr-4">
                                ...
                                <p className="text-[10px] text-slate-400 dark:text-slate-500 font-medium truncate mt-0.5">{account.group}</p>
                            </div>
                            ...
                            <div className="text-right shrink-0 flex items-center gap-1.5">
                                ...
                                {account.balance < 0 && (
                                    <span className="inline-flex items-center text-rose-500" title="Saldo Minus">
                    ...
                    <div className="py-6 text-center text-slate-400 dark:text-slate-500 text-xs font-medium">Tidak ada data akun Kas/Bank.</div>
                )}
            </div>
        </div>
    );
