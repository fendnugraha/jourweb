      ...
      if (existing) {
        ...
        return [
          ...prevCart,
          {
            ...
            stockItemId:
              "stockItemId" in product ? product.stockItemId : undefined,
          },
        ];
      }
    });
        ...
        <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-3 max-h-145 overflow-y-auto pr-1">
                  ...
                  <div className="text-right">
                    {isOutOfStock ? (
                      ...
                      <span className="text-[10px] font-bold text-amber-500">
                        Cart Max ({currentStock})
                      </span>
                    ) : isStockItem ? (
                      <span
                        className={`text-[10px] font-medium ${currentStock <= 5 ? "text-rose-500 font-semibold" : "text-slate-400"}`}
                      >
                        {currentStock} left{" "}
          ...
          {filteredProducts.length === 0 && (
            <div className="col-span-full py-12 text-center text-slate-400 dark:text-slate-500">
              No matching POS products found in catalog.
            </div>
          )}
        </div>
      </div>
            ...
            {cart.length === 0 && (
              <div className="h-36 flex flex-col items-center justify-center text-center p-4">
                ...
                <p className="text-[10px] text-slate-400/80 mt-0.5 max-w-50">
                  Select café goods or inventory stock products from the left to
                  start checkout.
                </p>
              </div>
            )}
              ...
              >
                <div className="text-center pb-4 border-b border-dashed border-slate-200 dark:border-slate-800">
                  ...
                  <p className="text-[10px] text-slate-400 font-mono mt-0.5">
                    128 Sourdough Lane, Hearthstone CA
                  </p>
