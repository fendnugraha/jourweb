    ...
    return (
        ...
        >
            ...
            >
                ...
                <h1 className="text-2xl font-bold text-white mb-1">Absensi Berhasil!</h1>
                ...
                <div className="bg-slate-800/40 border border-slate-800 rounded-2xl p-4 text-left space-y-3 mb-6 text-xs">
                    <div className="flex items-center justify-between pb-2.5 border-b border-slate-800/60">
                        ...
                        <span className="font-semibold text-white">{att?.contact?.name || att?.name || "-"}</span>
                    </div>
                    ...
                    <div className="flex items-center justify-between pb-2.5 border-b border-slate-800/60">
                        ...
                        <span className="font-semibold text-slate-200">{att?.date ? formatLongDate(att.date, true) : "-"}</span>
                    </div>
