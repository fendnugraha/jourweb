...
export default function SubTabSwitcher({ subMenuTabs, activeSubTab, setActiveSubTab }) {
    return (
        <div className="p-1 bg-slate-200 dark:bg-slate-700 rounded-2xl inline-flex gap-1 border border-slate-200/60 dark:border-slate-700/50 shadow-2xs">
            {subMenuTabs.map((tab) => {
                const Icon = tab.icon;
                ...
                return (
                    ...
                    >
                        ...
                        <tab.icon className={`h-3.5 w-3.5 z-10 transition-colors ${isActive ? "text-indigo-600 dark:text-indigo-400" : "text-slate-400"}`} />
